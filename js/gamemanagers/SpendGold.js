game.SpendGold = Object.extend({
    ...
    makePurchase: function(skill){
        if(skill === 1){
            ...
            game.data.gold -= ((game.data.gold.skill2 + 1) * 10);
            game.data.skill2 += 1;
        }else if(skill ===3){
            game.data.gold -= ((game.data.gold.skill3 + 1) * 10);
            game.data.skill3 += 1;
        }else if(skill ===4){
            game.data.gold -= ((game.data.gold.ability1 + 1) * 10);
            game.data.ability1 += 1;
        }else if(skill ===5){
            game.data.gold -= ((game.data.gold.ability2 + 1) * 10);
            game.data.ability2 += 1;
        }else if(skill ===6){
            game.data.gold -= ((game.data.gold.ability3 + 1) * 10);
